...
def login_required_admin(view_func):
    ...
    test = user_passes_test(test, login_url='Core:main', redirect_field_name=None)
...
def whitelist_view(request):
    ...
    return render(request, 'CRM_ADMIN/whitelist.html', data)
...
def items_view(request):
    ...
    return render(request, 'CRM_ADMIN/items.html', data)
